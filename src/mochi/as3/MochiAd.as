    ...
    public class MochiAd {
        ...
        public static function load(options:Object):MovieClip {
            ...
            */
            ...
            var server:String = options.server;
            var hostname:String = _allowDomains(server);
            options.server = server + "srv/1/"+ options.id +".json?do_init=1";
            ...
            var req:URLRequest = new URLRequest(server + "ctr/MochiAdsCDN-AS3.swf?do_init=1&cacheBust=" + new Date().getTime());
